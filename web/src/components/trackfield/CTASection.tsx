...
const metadata = [
  { label: "Case", value: "Track&Field - Automação de Processos", icon: Zap },
  { label: "Timeline", value: "2 meses (2024-2025)", icon: Calendar },
  { label: "Role", value: "Analista de Marketing (Automação)", icon: User },
  { label: "Stack", value: "n8n, Google Sheets, APIs", icon: Cpu },
  { label: "Resultado", value: "-87% tempo de processo", icon: CheckCircle },
      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              ...
              <h3 className="font-display text-2xl sm:text-3xl lg:text-4xl font-light text-white">
                ...
                <span className="text-emerald-400">operação</span>?
              </h3>

              <p className="text-neutral-400 leading-relaxed">
                Se processos manuais estão travando seu crescimento, vamos
                conversar. Automação inteligente + execução prática = eficiência
                real.
              </p>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <a
                  href="https://wa.me/5511997627772?text=Oi%2C%20gostei%20do%20seu%20case%20Track%26Field%20e%20gostaria%20de%20te%20chamar%20pra%20uma%20oportunidade"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Vamos conversar
        ...
        >
          <div className="flex items-center justify-center gap-2 text-neutral-500 text-sm">
            <span>Estudo de caso Track&Field 2025</span>
          </div>
        </motion.div>
      </div>
    </section>
