...
const metadata = [
  { label: "Case", value: "Zippi - SEO & Growth", icon: TrendingUp },
  { label: "Timeline", value: "60 dias (Ago-Out 2022)", icon: Calendar },
  { label: "Role", value: "Growth Specialist (SEO, Conteúdo)", icon: User },
  { label: "Stack", value: "Semrush, Google Analytics, WordPress", icon: Cpu },
  { label: "Resultado", value: "+150% tráfego orgânico", icon: CheckCircle },
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="relative grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <a
                  href="https://wa.me/5511997627772?text=Oi%2C%20gostei%20do%20seu%20case%20Zippi%20e%20gostaria%20de%20te%20chamar%20pra%20uma%20oportunidade"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Vamos conversar
        ...
        >
          <div className="flex items-center justify-center gap-2 text-neutral-500 text-sm">
            <span>Estudo de caso Zippi 2025</span>
          </div>
        </motion.div>
      </div>
    </section>
