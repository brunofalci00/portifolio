  ...
  const insights = [
    {
      ...
      description: "20 artigos bons lançados valem mais que 5 artigos perfeitos que nunca saem.",
    },
    {
      icon: BarChart3,
      title: "Dados Guiam Decisões",
      description: "Ferramentas como Semrush revelam oportunidades que intuição não captura.",
    },
    {
      icon: RefreshCw,
      title: "SEO é Iterativo",
      description: "Otimização contínua pós-publicação traz resultados melhores que acertar de primeira.",
    },
  ];
          ...
          >
            ...
            <div className="relative z-10 space-y-6">
              ...
              <blockquote className="text-2xl sm:text-3xl lg:text-4xl font-light text-white max-w-4xl mx-auto leading-tight">
                SEO não é sobre hackear algoritmos.
                <br />É sobre criar{" "}
                <span className="text-emerald-400">valor consistente</span>.
              </blockquote>
