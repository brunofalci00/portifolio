...
export function ConclusionSection() {
  const insights = [
    {
      icon: Target,
      title: "Proatividade > Reatividade",
      description: "Responder rapidamente evita que frustracoes virem crises de reputacao.",
    },
    {
      icon: BarChart3,
      title: "Dados Guiam CX",
      description: "NPS e analise de sentimento revelam padroes que intuicao nao captura.",
    },
    {
      icon: RefreshCw,
      title: "Reviews sao Oportunidade",
      description: "Cada feedback negativo e uma chance de converter critico em advogado.",
    },
  ];
        ...
        <div className="space-y-16">
          ...
          >
            ...
            <div className="relative z-10 space-y-6">
              ...
              <blockquote className="text-2xl sm:text-3xl lg:text-4xl font-light text-white max-w-4xl mx-auto leading-tight">
                Nao existe solucao, produto ou empresa que funcione sem colocar{" "}
                <span className="text-emerald-400">o cliente no centro</span>.
              </blockquote>
              <div className="text-6xl text-emerald-400/20 rotate-180">"</div>
            </div>
          </motion.div>
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 ring-1 ring-white/10">
              <span className="text-sm text-neutral-300">Reflexoes</span>
            </div>
