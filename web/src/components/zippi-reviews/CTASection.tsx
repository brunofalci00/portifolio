...
const metadata = [
  { label: "Case", value: "Zippi - Review Management", icon: Star },
  { label: "Timeline", value: "3 meses (2023)", icon: Calendar },
  { label: "Role", value: "Growth & Community Manager", icon: User },
  { label: "Stack", value: "ReclameAQUI, Google Reviews, Automação", icon: Cpu },
  { label: "Resultado", value: "90% satisfação nos reviews", icon: CheckCircle },
      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              ...
              <h3 className="font-display text-2xl sm:text-3xl lg:text-4xl font-light text-white">
                ...
                <span className="text-emerald-400">reputação online</span>?
              </h3>

              <p className="text-neutral-400 leading-relaxed">
                Se sua marca precisa de uma gestão inteligente de reviews e
                relacionamento com clientes, vamos conversar. Estratégia de
                community + automação = reputação sólida.
              </p>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <a
                  href="https://wa.me/5511997627772?text=Oi%2C%20gostei%20do%20seu%20case%20Zippi%20Reviews%20e%20gostaria%20de%20te%20chamar%20pra%20uma%20oportunidade"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Vamos conversar
        ...
        >
          <div className="flex items-center justify-center gap-2 text-neutral-500 text-sm">
            <span>Estudo de caso Zippi Reviews 2023</span>
          </div>
        </motion.div>
      </div>
    </section>
