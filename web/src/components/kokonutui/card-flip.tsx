...
export default function CardFlip({
    ...
    return (
        <div
            className="relative w-[280px] h-[320px] group [perspective:2000px]"
                                    ...
                                    {[...Array(10)].map((_, i) => (
                                        <div
                                            ...
                                            className={cn(
                                                ...
                                                "opacity-0",
                                                "shadow-[0_0_50px_rgba(16,185,129,0.5)]",
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5 bg-gradient-to-t from-black/80 via-black/40 to-transparent">
                        <div className="flex items-center justify-between gap-3">
                            <div className="space-y-1.5">
                                ...
                                <p className="text-sm text-gray-100 line-clamp-2 tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-4px] delay-[50ms]">
                                    {subtitle}
                                </p>
                            </div>
                            <div className="relative group/icon">
                                ...
                                />
                                <Repeat2 className="relative z-10 w-4 h-4 text-emerald-500 transition-transform duration-300 group-hover/icon:scale-110 group-hover/icon:-rotate-12" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <style jsx>{`
                @keyframes scale {
                    0% {
                        transform: scale(2);
                        opacity: 0;
                        box-shadow: 0px 0px 50px rgba(16, 185, 129, 0.5);
                    }
                    50% {
                        transform: translate(0px, -5px) scale(1);
                        opacity: 1;
                        box-shadow: 0px 8px 20px rgba(16, 185, 129, 0.5);
                    }
                    100% {
                        transform: translate(0px, 5px) scale(0.1);
                        opacity: 0;
                        box-shadow: 0px 10px 20px rgba(16, 185, 129, 0);
                    }
                }
            `}</style>
        </div>
