      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-neutral-400 leading-relaxed">
                Se você curtiu o processo, a atenção aos detalhes e a mentalidade de
                builder, vamos conversar. Estou sempre aberto a novos desafios e
                oportunidades.
              </p>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <a
                  href="https://wa.me/5511997627772?text=Oi%2C%20gostei%20do%20seu%20case%20Bora%20e%20gostaria%20de%20te%20chamar%20pra%20uma%20oportunidade"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Vamos conversar
              ...
              <Button
                asChild
                variant="ghost"
                className="h-14 px-8 text-base text-neutral-400 hover:text-white rounded-xl group"
              >
                <Link href="/#projetos">
        ...
        >
          <div className="flex items-center justify-center gap-2 text-neutral-500 text-sm">
            <span>Estudo de caso Bora 2025</span>
          </div>
        </motion.div>
      </div>
    </section>
