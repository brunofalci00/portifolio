...
const metadata = [
  { label: "Case", value: "Trendly - Growth Marketing", icon: TrendingUp },
  { label: "Timeline", value: "6 meses (2024)", icon: Calendar },
  {
    label: "Role",
    value: "Growth Strategist (Estratégia, Conteúdo, IA)",
    icon: User,
  },
  {
    label: "Stack",
    value: "ChatGPT, Claude, Descript, Zapier, Metricool",
    icon: Cpu,
  },
  { label: "Resultado", value: "R$0 → R$100k receita", icon: CheckCircle },
...
export function CTASection() {
  return (
    <section id="cta" className="relative py-24 bg-neutral-900/50">
      {/* Gradiente de transição do topo (última seção) */}
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <div className="relative grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              ...
              <h3 className="font-display text-2xl sm:text-3xl lg:text-4xl font-light text-white">
                ...
                <span className="text-emerald-400">presença digital</span>?
              </h3>

              <p className="text-neutral-400 leading-relaxed">
                Se você é especialista com conhecimento profundo, mas sua
                presença digital não reflete isso, vamos conversar. Estratégia
                personalizada + execução com IA = resultados reais.
              </p>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <a
                  href="https://wa.me/5511997627772?text=Oi%2C%20gostei%20do%20seu%20case%20Trendly%20e%20gostaria%20de%20te%20chamar%20pra%20uma%20oportunidade"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Vamos conversar
        ...
        >
          <div className="flex items-center justify-center gap-2 text-neutral-500 text-sm">
            <span>Estudo de caso Trendly 2025</span>
          </div>
        </motion.div>
      </div>
    </section>
